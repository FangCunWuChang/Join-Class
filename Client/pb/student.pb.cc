...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_student_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::JC::Student, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::JC::Student, id_),
  PROTOBUF_FIELD_OFFSET(::JC::Student, name_),
  PROTOBUF_FIELD_OFFSET(::JC::Student, classes_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::JC::Student)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::JC::_Student_default_instance_),
};

const char descriptor_table_protodef_student_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rstudent.proto\022\002JC\"4\n\007Student\022\n\n\002id\030\001 \001"
  "(\t\022\014\n\004name\030\002 \001(\t\022\017\n\007classes\030\003 \003(\tb\006proto"
  "3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_student_2eproto = {
  false, false, 81, descriptor_table_protodef_student_2eproto, "student.proto", 
...
Student::Student(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:JC.Student)
}
Student::Student(const Student& from)
  ...
  // @@protoc_insertion_point(copy_constructor:JC.Student)
}
...
Student::~Student() {
  // @@protoc_insertion_point(destructor:JC.Student)
...
void Student::Clear() {
// @@protoc_insertion_point(message_clear_start:JC.Student)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "JC.Student.id"));
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "JC.Student.name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          do {
            ...
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "JC.Student.classes"));
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* Student::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:JC.Student)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:JC.Student)
  return target;
}

size_t Student::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:JC.Student)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:JC.Student)
...
// @@protoc_insertion_point(class_specific_copy_from_start:JC.Student)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::JC::Student* Arena::CreateMaybeMessage< ::JC::Student >(Arena* arena) {
  return Arena::CreateMessageInternal< ::JC::Student >(arena);
}
